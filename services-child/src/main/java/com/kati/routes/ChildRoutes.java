...
import com.kati.beans.ChildGreetingBean;
...
public class ChildRoutes extends RouteBuilder {
    ...
    @Autowired
    ChildGreetingBean childGreetingBean;
    ...
    public static final String CHILD_POST_ROUTE_ID= "child-post-route";
    public static final String CHILD_GET_ROUTE_ID= "child-get-route";
    ...
    public void configure() throws Exception {
        ...
        // the request from .get("/child") comes here -- this can be invoked from browser
        from("direct:get-childroute")
                .routeId(CHILD_GET_ROUTE_ID)
                .bean(childGreetingBean, "sayHello") //object Reference + methodname
